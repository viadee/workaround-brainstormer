...
HOSTNAME = "dev.brainstormer.cwa.viadee.cloud"
...
class DevDeployment:
    ...
    def build(self) -> None:
        ...
        ContainerApp(
            ...
            host_name=HOSTNAME,
            certificate_id=f"/subscriptions/{self.subscription_id}/resourceGroups/{self.rg_name}/providers/Microsoft.App/managedEnvironments/wa-brainstormer-container-app-environment-dev/managedCertificates/dev.brainstormer.cwa.viadee-wa-brain-250429062411",
            identity=managed_identity.identity,
